...
⍝ ⎕AVU from Classic 12.1                                                                                                                                                                                            ↓↓↓↓                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ↓↓↓↓
      ...
      :If 2=⎕NC'vers'
          ...
          :Case 13     ⍝ ⎕AVU from 14.0 onwards (the only difference is ⊢ which was ¤ before )
    ...
    isChar ←{0 2∊⍨10|⎕DR ⍵}                          ⍝ determine if argument's datatype is character
      ...
      Ö←{ ⍝ ⍥ over/depth (AB's suggested operator)
   ...
   ⍝ naming convention: characters (any case) or "_" or digits (may not begin with a digit)
    ...
    ⍝ Process a .dyalogbuild file
      ...
      :If TestClassic>0
          ...
          :If 0<⍴z
              ∘∘∘
              LogError('Classic-Test found incompatible characters in following functions/variables:',⎕UCS 13 10),¯2↓∊z{('- ',⍺,⍵)/⍨×≢⍺}Ö 1⊢(⎕UCS 13 10)
          :Else
