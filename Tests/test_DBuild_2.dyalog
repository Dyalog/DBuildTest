 ...
 sink←180 sub_RunAPLProcess('')('LX=⎕SE.UCMD''"]DBuild ',##.TESTSOURCE,'DBuild_2.dyalogbuild -save=1 -p -off=0 -target=',wsid,' -off''"')(0)''(∊2↑⎕NPARTS logfile)(1⊃⎕NPARTS logfile)
 ...
 :If ('MyArray' 'array' 'london1' 'var')Check #.test2.⎕NL ¯2
