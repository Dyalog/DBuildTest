:Class APLProcess
    ...
    :Field Public IsSsh        
    :Field Public RIDE_INIT←''
    :Field Public OUT_FILE←''
    ...
    ∇ Start(ws args rt);psi;pid;cmd;host;port;keyfile;exe;z;output
      (Ws Args)←ws args
      args,←' RIDE_INIT="',RIDE_INIT,'"',(0≠≢RIDE_INIT)/' RIDE_SPAWNED=1' ⍝ NB Always set RIDE_INIT to override current process setting
